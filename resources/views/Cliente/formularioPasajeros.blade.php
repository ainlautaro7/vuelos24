...
{{-- action="{{ route('cliente.comprarBoleto') }}" method="POST" --}}
...
$preference->back_urls = [
    ...
    'success' => 'http://localhost/vuelos24/public/formulario',

    // al formulario de pago
    'failure' => 'http://localhost/vuelos24/public/comprarBoleto',

    // pagina con los vuelos del cliente
    'pending' => 'http://localhost/vuelos24/public/comprarBoleto',
];
